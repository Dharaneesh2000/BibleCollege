        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Why Word Bible College is Your Best Choice?
            </h2>
            <p className="text-lg text-gray-600 mb-8">
              We provide comprehensive theological education that combines academic excellence 
              with practical ministry training. Our programs are designed to equip students 
              with the knowledge, skills, and spiritual foundation necessary for effective 
              Christian service in today's world.
            </p>
          </div>
